...
module spi_slave_memory_tb;
    ...
    initial begin
      // Syntax: $sdf_annotate("FILENAME", INSTANCE_NAME);
      // Ensure "dut" matches the instance name of your counter below
         $sdf_annotate("/DB/Projects/180BCD/QRNG/QC_MTech_01/spi_slave_memory/synth_results_wc/spi_slave_memory_delay.sdf", dut); 
    end
